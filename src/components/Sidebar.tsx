      ...
      <div className="p-6">
        <div className="relative mb-6">
          <input
            type="text"
            placeholder="Search"
            className="w-full pl-10 pr-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-orange-500 placeholder-gray-600"
          />
        ...
        <nav className="space-y-2">
          ...
          <a href="#" className="flex items-center space-x-3 px-3 py-2 bg-orange-50 text-orange-600 rounded-lg">
            <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="absolute bottom-0 left-0 w-64 p-6">
        <div className="border border-orange-200 bg-orange-50 rounded-lg p-4 mb-4">
          <div className="flex items-center space-x-2 mb-2">
            ...
            <span className="text-sm font-medium text-orange-800 font-mono">What's New</span>
          </div>
          <p className="text-xs text-orange-700 font-mono">View our latest update</p>
        </div>
        ...
        <div className="flex items-center space-x-3 mb-4">
          ...
          <div>
            <p className="text-sm font-medium text-gray-900 font-mono">rafael@sideguide.dev</p>
          </div>
        </div>
        ...
        <button className="flex items-center space-x-2 text-gray-500 hover:text-gray-700">
          ...
          <span className="text-sm font-mono">Collapse</span>
        </button>
      </div>
    </aside>
  )
